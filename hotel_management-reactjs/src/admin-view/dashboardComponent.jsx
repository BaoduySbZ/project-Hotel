...
import { getRevenue, getCircleRevenue } from "../service/revenueService"; // Import the booking service functions
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchRevenue = async () => {
      try {
        const revenueData = await getRevenue(); // Gọi API để lấy dữ liệu
        console.log(revenueData);
        setMonthlyData(revenueData); // Lưu dữ liệu vào state
      } catch (error) {
        console.error("Lỗi khi lấy dữ liệu doanh thu:", error);
      }
    };

    const fetchCircleRevenue = async () => {
      try {
        const circleRevenueData = await getCircleRevenue(); // Gọi API để lấy dữ liệu doanh thu hình tròn
        console.log(circleRevenueData);
        setRevenueData(circleRevenueData); // Lưu dữ liệu vào state
      } catch (error) {
        console.error("Lỗi khi lấy dữ liệu doanh thu hình tròn:", error);
      }
    };
